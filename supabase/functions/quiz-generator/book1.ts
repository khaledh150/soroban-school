// book1.ts - Book 1 Generator Functions

export type Question = { q: string; a: string };
export type GenFn = (numQuestions?: number, numNumbers?: number) => Question[];

// --- HELPER: Fill array with repeats if we ran out of unique questions ---
export function fillQuestions(questions: Question[], target: number): Question[] {
...
// Export all Book 1 generator functions
export const book1Generators: Record<number, GenFn> = {
  1: randomChapter1Lower,
  2: randomChapter2Lower2Digits,
  3: randomChapterChapter3Upper,
  4: randomChapter4MixLowerUpper,
  5: randomChapter5MixUpperLower2Digits,
  6: randomChapter6FivebuddyPlus4,
  7: randomChapter7FivebuddyPlus3,
  8: randomChapter8FivebuddyPlus2,
  9: randomChapter9FivebuddyPlus1,
  10: randomChapter10FiveBuddyPlus,
  11: randomChapter11FiveBuddyMinus4,
  12: randomChapter12FivebuddyMinus3,
  13: randomChapter13FivebuddyMinus2,
  14: randomChapter14FivebuddyMinus1,
  15: randomChapter15FiveBuddyMinus,
  16: randomChapter16FiveBuddyPlusMinus,
  17: randomChapter17Mix5buddy2digits,
};
